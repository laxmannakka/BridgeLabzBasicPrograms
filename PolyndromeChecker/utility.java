...
public class utility<E>
{
    ...
    Deque <E> rear;
    int size =0;
    // it will returns the tru or false
    ...
    // this function add the node into rear 
    ...
    //this functiom remove the last elemet of queue
    public E removeRear()
    {
        E val = null;
        if(front == null)
    ...
    // function size this size returns the size
    public int size()
    {
        return size;
    }
