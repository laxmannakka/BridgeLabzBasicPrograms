...
public class OrderedList
{
    ...
    void removeWord(int count)
    {
        ...
        else
        {
            ...
            System.out.println("After Deleting LIst is ");
            display(); // after removing the display data
        }
    }
    ...
    {
        // Creating the object of Ordered list
        OrderedList obj = new OrderedList();
        // calling the function get data from a file
        obj.getDataFromFile();
        obj.display(); // calling the display function
        obj.size(); // calling the size function 
        obj.serchWord();// Search word calling the function
    }
}
