...
public class MultiDimention 
{
    ...
    public static void main(String args[]) {
        ...
        double[][] doublearray =new double[row][col]; // double array Declaration
        boolean[][] booleanarray = new boolean[row][col]; // boolean Array DEclaration
        // overLoading The Display Function Here
        obj.display(row,col,array);  
        obj. display(row,col,doublearray);
        obj. display(row,col,booleanarray);
